 ...
 * @param file the path of the document file to use
 */
export const swaggerFile = (directory: string, file: string): string => path.join(rxSubdirectory(directory, file), 'swagger.json')
 ...
 * @param file the path of the document file to use
 */
export const swaggerWithMocksFile = (directory: string, file: string): string => path.join(rxSubdirectory(directory, file), 'swagger.mock.json')
 ...
 * @param file the path of the document file to use
 */
export const deployFile = (directory: string, file: string): string => path.join(rxSubdirectory(directory, file), 'deploy.json')
 ...
 * @param file the path of the document file to use
 */
export const readSwaggerFile = async (directory: string, file: string): Promise<OpenAPIV2.Document> => yaml.parse((await fse.readFile(swaggerFile(directory, file))).toString())
 ...
 */
export const writeSwaggerFile = (directory: string, file: string, specification: OpenAPIV2.Document): Promise<void> => fse.writeFile(swaggerFile(directory, file), yaml.stringify(specification))
 ...
 * @param file the path of the document file to use
 */
export const readSwaggerWithMocksFile = async (directory: string, file: string): Promise<OpenAPIV2.Document> => yaml.parse((await fse.readFile(swaggerWithMocksFile(directory, file))).toString())
 ...
 * @param specification the Swagger specification object
 */
export const writeSwaggerWithMocksFile = (directory: string, file: string, specification: OpenAPIV2.Document): Promise<void> => fse.writeFile(swaggerWithMocksFile(directory, file), yaml.stringify(specification))
 ...
 * @param file the path of the document file to use
 */
export const readDeployFile = async (directory: string, file: string): Promise<Deploy> => yaml.parse((await fse.readFile(deployFile(directory, file))).toString())
 ...
 */
export const writeDeployFile = (directory: string, file: string, deploy: Deploy): Promise<void> => fse.writeFile(deployFile(directory, file), yaml.stringify(deploy))
